...
# Once you enable the color, ensure you close the color with \e[0m, if not color won't end

# Prining Foreground text
...
echo -e "\e[44;31m Singham is a very good film \e[0m "
