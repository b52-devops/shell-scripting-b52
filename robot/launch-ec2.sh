...
aws ec2 run-instances --image-id ${AMI_ID} --count 1 --instance-type t2.micro --security-group-ids ${SG_ID} --tag-specifications 'ResourceType=instance,Tags=[Key=Name,Value=${COMPONENT}]'
